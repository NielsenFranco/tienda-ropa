        ...
        <div class="prenda-info">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <button id="probarPrendaBtn"
                        ...
                        data-tipo-prenda="<?php echo htmlspecialchars($prenda['categoria']); ?>">
                    Pruébate la prenda
                </button>
...
<script>
    const TRYON_PROXY_URL = "<?php echo BASE_URL; ?>/proxy_tryon_hf.php";
    const BASE_URL = "<?php echo BASE_URL; ?>";
</script>
<script src="<?php echo BASE_URL; ?>/assets/js/tryon.js"></script>
